...
from cart.serializers import CartItemSerializer, CartSerializer,UserSerializer
...
#I commented this out because it is risky to exempt a view from csrf protection
# @csrf_exempt
...
#     else:
#         return JsonResponse({"error": "Method not allowed"}, status=405)
#To list all users , but i dont know if it is necessary
